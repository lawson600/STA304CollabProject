...
```{r Question 1 Figure 1, echo=FALSE,message = FALSE, warning = FALSE, fig.cap="Assault Rate by Toronto Neighbourhood (2023)"} 
crime_2023 <- crime %>%
...
```{r Question 3 Figure 1, echo = FALSE,message = FALSE, warning = FALSE}
...
```{r, ref.label="Question 1 Figure 1", echo = TRUE, eval = FALSE}
